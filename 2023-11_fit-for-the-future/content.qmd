...
## Open-source software <img width='10%' align='right' src='images/Rlogo.svg' alt=''/> 

* Free for anybody to use

* Active support community

* Flexible: data cleaning, analysis, modelling, visualisation, reporting (and more!)

* R is the most widely used and supported in the Scottish Government

::: {.notes}
* Proprietary software such as SAS, Microsoft Excel, or Tableau means your analysis is not truly reproducible because you cannot run the process without owning a license. 
:::
...
* Function arguments allow you to re-use the function for 'similar' actions

* Reduces effort to maintain code
