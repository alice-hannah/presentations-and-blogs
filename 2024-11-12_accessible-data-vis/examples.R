...
ggsave(
  ex1, 
  filename = here("2024-03-13_accessible-data-vis", "images", "ex1.svg"),
...
ggsave(
  ex1_bw, 
  filename = here("2024-03-13_accessible-data-vis", "images", "ex1_bw.svg"),
  width = 200, height = 100, units = "mm"
)
...
ggsave(
  ex2, 
  filename = here("2024-03-13_accessible-data-vis", "images", "ex2.svg"),
  width = 200, height = 100, units = "mm"
)
...
ggsave(
  ex3, 
  filename = here("2024-03-13_accessible-data-vis", "images", "ex3.svg"),
...
save_html(
  as_raw_html(table),
  here("2024-03-13_accessible-data-vis", "images", "table.html")
)
