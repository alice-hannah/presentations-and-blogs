...
* More information on using Git safely can be found in the [Duck Book](https://best-practice-and-impact.github.io/qa-of-code-guidance/version_control.html#avoid-committing-sensitive-information-to-git-repositories).
...
* For this reason, it's also important not to include sensitive information in your code files that are tracked by Git. For example, avoid hard-coding data, passwords, or sensitive information.
:::
