...
* It's also important not to include sensitive information in your code files that are tracked by Git. For example, avoid hard-coding data, passwords, or sensitive information.
:::
