...
## <img width='15%' align='right' src='images/sgplot-logo.svg' alt=''/> <br> sgplot 
...
* Sets default ggplot2 theme to `theme_sg`

* Sets default colour palettes

* Sets default geom aesthetics; e.g. sets size of lines, bars and points relative to sizes used in theme
